...
def main():
    """Example usage of the Preferences Manager"""
    ...
    print(yaml.dump(all_prefs, default_flow_style=False, sort_keys=False))
    ...
    # Example: Change a preference
    print("\nChanging AI model to 'gpt-4'...")
    manager.set("ai.model", "gpt-4")
    manager.save()
    
    print(f"New AI model: {manager.get('ai.model')}")
