...
class TestCortexCLI(unittest.TestCase):
    ...
    def test_main_install_command(self, mock_install) -> None:
        ...
        result = main()
        self.assertEqual(result, 0)
        mock_install.assert_called_once_with("docker", execute=False, dry_run=False, simulate=False)
    ...
    def test_main_install_with_execute(self, mock_install) -> None:
        ...
        result = main()
        self.assertEqual(result, 0)
        mock_install.assert_called_once_with("docker", execute=True, dry_run=False, simulate=False)
    ...
    def test_main_install_with_dry_run(self, mock_install) -> None:
        ...
        result = main()
        self.assertEqual(result, 0)
        mock_install.assert_called_once_with("docker", execute=False, dry_run=True, simulate=False)
